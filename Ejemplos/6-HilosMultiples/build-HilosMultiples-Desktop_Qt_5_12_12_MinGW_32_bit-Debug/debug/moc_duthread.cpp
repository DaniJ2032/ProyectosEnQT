...
#include "../../HilosMultiples/duthread.h"
...
QT_MOC_LITERAL(1, 9, 13), // "ValorCambiado"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "DuThread\0ValorCambiado\0"
};
...
void DuThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ValorCambiado((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DuThread::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DuThread::ValorCambiado)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DuThread::ValorCambiado(int _t1)
{
